...
--
CREATE DATABASE IF NOT EXISTS `cr13_branislav_simic_bigevents` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cr13_branislav_simic_bigevents`;
